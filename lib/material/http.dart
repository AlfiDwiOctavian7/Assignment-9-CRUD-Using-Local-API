...
String localAddres = "192.168.74.217:8088";
...
Future<http.Response> getData() async {
  var result =
  await http.get(Uri.parse("http://$localAddres/api/user/getAllUser"));
  print(result.body);
  return result;
}
...
Future<http.Response> postData() async {
  ...
  var result = await http.post(
    Uri.parse("http://$localAddres/api/user/createUser"),
...
Future<http.Response> updateData(id) async {
  ...
  var result = await http.put(
    Uri.parse("http://$localAddres/api/user/updateUser/${id}"),
    headers: <String, String>{
      "Content-Type": "application/json; charset=UTF-8",
    },
    body: jsonEncode(data),
...
Future<http.Response> deleteData(id) async {
  var result = await http.delete(
    Uri.parse("http://$localAddres/api/user/deleteUser/${id}"),
    headers: <String, String>{
      "Content-Type": "application/json; charset=UTF-8",
    },
  );
                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      title: Text(
                          "${json[index]['name']} | ${json[index]['gender']}"),
